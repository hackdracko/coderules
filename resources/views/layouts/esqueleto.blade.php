<!doctype html>
<html lang="">
    <!-- Mirrored from milestone.nyasha.me/latest/html/blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2016 15:37:57 GMT -->
    <head>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1">
        <meta name="msapplication-tap-highlight" content="no"><meta name="mobile-web-app-capable" content="yes">
    ...
    <body>
        <div class="app">
            <div class="off-canvas-overlay" data-toggle="sidebar">
            </div>
            <div class="sidebar-panel">
                <div class="brand">
                    ...
                    <a class="brand-logo">
                        <img class="expanding-hidden" src="img_admin/logo.png" alt="">
                    </a> </div><div class="nav-profile dropdown">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown">
                        <div class="user-image"><img src="img_admin/avatar.jpg" class="avatar img-circle" alt="user" title="user">
                        </div>
                    ...
                    <div class="header-inner">
                        <div class="navbar-item navbar-spacer-right brand hidden-lg-up">
                            ...
                            <a class="brand-logo hidden-xs-down">
                                <img src="img_admin/logo_white.png" alt="logo">
                            </a>
                        </div>
                                        ...
                                        <div class="notifications-wrapper">
                                            <ul class="notifications-list">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <span class="notification-icon">
                                                            <span class="circle-icon bg-info text-white">
                                                                J
                                                            </span>
                                                        </span>
                                                        <div class="notification-message">
                                                            <b>Jack Hunt</b> has <b>joined</b>
                                                            mailing list
                                                            <span class="time">
                                                                9 days ago
                                                            </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <span class="notification-icon">
                                                            <span class="circle-icon bg-primary text-white">
                                                                C
                                                            </span>
                                                        </span>
                                                        <div class="notification-message">
                                                            <b>Conan Johns</b> created a new list
                                                            <span class="time">
                                                                9 days ago
                                                            </span>
                                                        </div>
                    ...
                    <div class="content-footer">
                        ...
                        <nav class="footer-left">
                            <ul class="nav">
                                <li>
                                    <a href="javascript:;">
                                        <span>Copyright</span> &copy; 2016 Your App
                                    </a>
                                </li>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="chat-header">
                            <div class="pull-right dropdown">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <a class="dropdown-item" href="javascript:;" data-dismiss="modal">
                                        Close chat
                                    </a>
                                </div>
                            </div>
                            <div class="chat-conversation-title">
                                <img src="img_admin/face1.jpg" class="avatar avatar-xs img-circle m-r-1 pull-left" alt="">
                        ...
                        <div class="modal-body flex scroll-y">
                            ...
                            <div class="chat-conversation-user me"><div class="chat-conversation-message">
                                    <p>Goodnight!</p>
                                </div>
                            </div>
                            <div class="chat-conversation-user them">
        ...
        <script src="js/scripts_admin/app.min.js">
