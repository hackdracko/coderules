...
<head>
    ...
    <meta name="author" content="Roman C. Jimenez">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li @yield('active')><a href="/inicio">Inicio</a>
                    </li>
                    <li><a href="index.html">Cultura Corporativa</a>
                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            ...
                            <li><a href="/inicio">Cultura Corporativa</a>
                            </li>
                            <li><a href="/inicio">Contactanos</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <p><strong>Franslux</strong>
                            <br>13/25 New Avenue
                            <br>New Heaven
                            <br>45Y 73J
                            <br>England
                            <br>
                            <strong>CD. México</strong>
                        </p>

                        <a href="#">Ir a página de Contacto</a>
 ...
 _________________________________________________________ -->
        <div id="copyright">
            <div class="container">
                ...
                <!--<div class="col-md-6">
                    <p class="pull-right">Contactanos <a href="#">:D</a> FRANSLUX <a href="#">----</a> 
